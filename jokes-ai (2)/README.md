...
- **Voice:** `speak.js` mein `voice: "troy"` → English voices mein se koi bhi try kar sakte hain (Orpheus ke valid voices console.groq.com/docs/text-to-speech/orpheus par list hain)
